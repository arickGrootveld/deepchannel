...
% v1.0, 9/29/2020, AEGrootveld, Added functionality to save figures
%                               so that plotting can be done
%                               on remote machines
...
infile1 = 'test2.mat';      % file of input data (target trajectories, system parameters)
infile2 = 'test2_imm.mat';  % file of IMM results
infile3 = 'test2_tcn.mat';  % file of TCN results... should contain a single matrix called YY
