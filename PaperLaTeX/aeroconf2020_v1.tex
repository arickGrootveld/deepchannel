...
\end{bmatrix}
\end{eqnarray*}
Where the first index for each element corresponds to the process ID and the second index is the sample number in that specific AR process. 
